...
from immunebuilder3.openfold.model.heads import PerResidueLDDTCaPredictor
from immunebuilder3.openfold.model.primitives import (
    LayerNorm,
    Linear,
    ipa_point_weights_init_,
)
from immunebuilder3.openfold.np.residue_constants import (
    restype_atom14_mask,
